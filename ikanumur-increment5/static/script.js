...
/* Part 3: Responsive Hamburger Menu Toggle */
function toggleNav() {
...
function loadMap() {
    ...
    if (document.getElementById('map')) {
        // Coordinates for CMU / Pittsburgh area
        var museumLocation = [40.4433, -79.9436]; 
        
        var map = L.map('map').setView(museumLocation, 15);
        ...
        // Add a marker for MonoMuse
        var marker = L.marker(museumLocation).addTo(map);
        marker.bindPopup("<b>MonoMuse Museum</b><br>123 Tech Way, Pittsburgh, PA").openPopup();
    }
}
